...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div><div class="col-xl-8 col-lg-8"><div class="services-details__content"><img${ssrRenderAttr("src", _imports_0)} alt=""><h3 class="mt-4">Webbutveckling</h3><p style="${ssrRenderStyle({ "text-align": "justify" })}"> Upplev omfattande webbapputvecklingstjänster som sömlöst integreras i ditt digitala ekosystem. Vårt erfarna team av utvecklare förverkligar dina idéer och levererar robusta och skalbara webbapplikationer som är skräddarsydda för att möta dina unika affärskrav. Låt oss vara ryggraden i din onlineframgång. </p><div class="content mt-40"></div></div></div></div></div></section>`);
    };
  }
};
...
//# sourceMappingURL=website-development-sj2yfbjC.js.map
