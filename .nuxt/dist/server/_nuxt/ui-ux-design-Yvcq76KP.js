...
import { _ as _imports_0 } from "./service-3-WjbJiV9N.js";
import "../server.mjs";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div><div class="col-xl-8 col-lg-8"><div class="services-details__content"><img${ssrRenderAttr("src", _imports_0)} alt=""><h3 class="mt-4">UI / UX Services</h3><p style="${ssrRenderStyle({ "text-align": "justify" })}"> Embark on a user-centric journey with our professional UI/UX services. Seamlessly integrated into your website, our expertise enhances user experiences to a whole new level. We believe in crafting interfaces that not only captivate but also engage, ensuring your digital presence stands out in a crowded online landscape. </p><div class="content mt-40"></div></div></div></div></div></section>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/innerpages/Uiux.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SectionsInnerpagesUiux = __nuxt_component_1;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_LayoutPageTitle, { title: "UI / UX Design" }, null, _parent));
      _push(ssrRenderComponent(_component_SectionsInnerpagesUiux, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/en/ui-ux-design.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=ui-ux-design-Yvcq76KP.js.map
