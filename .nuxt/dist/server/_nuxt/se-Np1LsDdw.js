...
import { mergeProps, withCtx, createTextVNode, createVNode, useSSRContext, ref, onUnmounted } from "vue";
...
import { b as _imports_0, _ as _imports_0$1, a as __nuxt_component_2$1 } from "./BackToTop-Km4QQZ62.js";
import { _ as _export_sfc } from "../server.mjs";
import { _ as _imports_1 } from "./logo-7mFUR9zJ.js";
import "ufo";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0)} width="25"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0,
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li><i class="fa fa-map-marker"></i>RoseTech AB, Företagsvägen 10, P.O. 227 61 Lund</li></ul></div><div class="top-right"><ul class="useful-links"><li>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/contact" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Hjälp`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0$1)} alt="" title="RoseTec AB"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0$1,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><div class="text">Välkommen till ROSETECH. Vi tar ditt företag till nästa nivå. </div><ul class="social-icon-two"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "https://www.facebook.com/profile.php?id=61558032923218",
    target: "_blank"
  }, {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/team" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Träffa Vårt Team`);
      } else {
        return [
          createTextVNode("Träffa Vårt Team")
        ];
      }
    }),
    _: 1
  ...
  _push(`</li></ul></div></div></div></div></div></div><div class="footer-bottom"><div class="auto-container"><div class="copyright-text">© Copyright ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} reserved by ROSETECH</div></div></div></footer>`);
}
...
//# sourceMappingURL=se-Np1LsDdw.js.map
