...
import { _ as __nuxt_component_1 } from './ServiceSE-2nPgYfec.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_LayoutPageTitleSE, { title: "Tj\xE4nster" }, null, _parent));
...
//# sourceMappingURL=services-6dlosLI8.mjs.map
