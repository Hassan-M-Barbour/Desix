...
import { _ as __nuxt_component_1 } from './Newsdetails-gQCD_SSM.mjs';
...
import './news-details-1-ftZV_1rG.mjs';
import '../../renderer.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_LayoutPageTitle, { title: "what is google gemini ai?" }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/en/what-is-google-gemini-ai.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=what-is-google-gemini-ai-ADAghEkl.mjs.map
