...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div><div class="col-xl-8 col-lg-8"><div class="services-details__content"><img${ssrRenderAttr("src", _imports_0)} alt=""><h3 class="mt-4">Web Applications Development</h3><p style="${ssrRenderStyle({ "text-align": "justify" })}"> Experience comprehensive web app development services that seamlessly integrate into your digital ecosystem. Our seasoned team of developers brings your ideas to life, delivering robust and scalable web applications tailored to meet your unique business requirements. Let us be the backbone of your online success. </p><div class="content mt-40"></div></div></div></div></div></section>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/innerpages/Webdevelopment.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SectionsInnerpagesWebdevelopment = __nuxt_component_1;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_LayoutPageTitle, { title: "Web Applications Development" }, null, _parent));
      _push(ssrRenderComponent(_component_SectionsInnerpagesWebdevelopment, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/en/website-development.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=website-development-_-euWDNl.mjs.map
