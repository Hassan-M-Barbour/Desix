...
import { _ as _imports_0 } from './service-4-UyLq7Y5o.mjs';
import '../server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div><div class="col-xl-8 col-lg-8"><div class="services-details__content"><img${ssrRenderAttr("src", _imports_0)} alt=""><h3 class="mt-4">Mobilapplikationer</h3><p style="${ssrRenderStyle({ "text-align": "justify" })}"> F\xF6rvandla din mobila n\xE4rvaro med v\xE5ra s\xF6ml\xF6sa mobilapputvecklingstj\xE4nster. Fr\xE5n koncept till implementering ser v\xE5rt team till att din mobilapplikation inte bara uppfyller utan \xF6vertr\xE4ffar anv\xE4ndarnas f\xF6rv\xE4ntningar. Sl\xE4pp l\xF6s kraften i anpassning och innovation f\xF6r en helt unik mobilupplevelse. </p><div class="content mt-40"></div></div></div></div></div></section>`);
    };
  }
};
...
//# sourceMappingURL=mobile-apps-development-r0ItHYoG.mjs.map
