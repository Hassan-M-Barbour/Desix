...
import { useSSRContext, mergeProps, withCtx, createVNode, createTextVNode } from 'file://C:/projects/desix/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr } from 'file://C:/projects/desix/node_modules/vue/server-renderer/index.mjs';
import { _ as _imports_0, a as _imports_1, b as _imports_2, c as _imports_3 } from './project-4-9sH5mCY_.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "projects-section p-7" }, _attrs))}><div class="auto-container"><div class="sec-title text-center"><span class="sub-title">V\xC5R PORTF\xD6LJ</span><h2>Utforska v\xE5ra nyligen <br>avslutade projekt</h2></div><div class="outer-box"><div class="row"><div class="project-block col-lg-3 col-md-6 wow fadeInUp"><div class="inner-box"><div class="image-box"><figure class="image">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "http://speedyphonefix.net",
    target: "_blank"
  }, {
  ...
  _push(`<span class="cat">Utveckling</span><h4 class="title">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "http://speedyphonefix.net",
    target: "_blank",
    title: ""
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Speedy Phone Fix`);
      } else {
        return [
          createTextVNode("Speedy Phone Fix")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`IA Engineering Group`);
      } else {
        return [
          createTextVNode("IA Engineering Group")
        ];
      }
    }),
    _: 1
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/home1/ProjectSE.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SectionsHome1ProjectSE = __nuxt_component_1;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_LayoutPageTitleSE, { title: "Projekt" }, null, _parent));
      _push(ssrRenderComponent(_component_SectionsHome1ProjectSE, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
//# sourceMappingURL=projects-YVHgzhrC.mjs.map
