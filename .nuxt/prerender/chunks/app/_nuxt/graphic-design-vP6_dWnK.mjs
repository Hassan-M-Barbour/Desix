...
import { _ as _imports_0 } from './service-2-cs_6HRf9.mjs';
import '../server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div><div class="col-xl-8 col-lg-8"><div class="services-details__content"><img${ssrRenderAttr("src", _imports_0)} alt=""><h3 class="mt-4">Grafisk Design </h3><p style="${ssrRenderStyle({ "text-align": "justify" })}"> Vi \xE4r glada att kunna tillhandah\xE5lla en professionell grafisk designtj\xE4nst som s\xF6ml\xF6st integreras med ditt varum\xE4rke. Med v\xE5r expertis kan vi f\xF6rb\xE4ttra din visuella identitet genom att skapa f\xE4ngslande grafik och attraktiva visuella stilar. Oavsett om du beh\xF6ver en fullst\xE4ndig omdesign av varum\xE4rket eller bara mindre justeringar, \xE4r vi h\xE4r f\xF6r att hj\xE4lpa till att f\xF6rb\xE4ttra din varum\xE4rkesimage f\xF6r st\xF6rre genomslag och engagemang. Kontakta oss idag f\xF6r att diskutera dina specifika behov och l\xE5t oss skapa en visuell identitet som skiljer dig fr\xE5n resten. </p><div class="content mt-40"></div></div></div></div></div></section>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/innerpages/GraphicdesignSE.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SectionsInnerpagesGraphicdesignSE = __nuxt_component_1;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_LayoutPageTitleSE, { title: "Grafisk Design" }, null, _parent));
      _push(ssrRenderComponent(_component_SectionsInnerpagesGraphicdesignSE, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/graphic-design.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=graphic-design-vP6_dWnK.mjs.map
