...
import { renderSSRHead } from 'file://C:/projects/desix/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/projects/desix/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/projects/desix/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/projects/desix/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/projects/desix/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/projects/desix/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/projects/desix/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/projects/desix/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/projects/desix/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/projects/desix/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/projects/desix/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/projects/desix/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/projects/desix/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/projects/desix/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/projects/desix/node_modules/unhead/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/projects/desix/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\projects\\desix","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\projects\\desix\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\projects\\desix\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\projects\\desix\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\projects\\desix\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _KMfrRwVA7p = (function(nitro) {
...
const resend$1 = new Resend(process.env.RESEND_API_KEY);
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"ROSETECH - TA DITT FÖRETAG TILL NÄSTA NIVÅ"};
...
const getClientManifest = () => import('file://C:/projects/desix/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/projects/desix/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
