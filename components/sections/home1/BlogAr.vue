	...
	<section class="news-section">
		<div class="auto-container">
			<div class="sec-title text-center">
				...
				<h2>تعرف على آخر الأخبار <br>التحديثات والمقالات</h2>
			</div>
			...
			<div class="row">
				...
				<div class="news-block col-lg-4 col-md-6 wow fadeInUp">
					<div class="inner-box">
						...
						<div class="content-box">
							...
							<ul class="post-info">
								<li><i class="fa fa-user-circle"></i>بواسطة المشرف</li>
				...
				<div class="news-block col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><NuxtLink to="/ar/content-strategy-examples"><img src="/images/resource/content-strategy.jpg" alt=""></NuxtLink></figure>
						</div>
						<div class="content-box">
							<span class="date">30 يونيو</span>
							<ul class="post-info">
